...
@screenshot_on_fail()
class TestUserLoginFromServicesPageNoSuchUserError(unittest.TestCase):
	...
	def test_user_login_logout(self):
		allure.dynamic.description("""
				...
				""")
		allure.dynamic.title("Services page > User Log In validation > Negative test > Empty fields")
