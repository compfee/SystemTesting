...
@screenshot_on_fail()
class TestUserLoginFromServicesPage(unittest.TestCase):
	...
	def test_user_login_logout(self):
		allure.dynamic.description("""
				User Log In validation > Login from Services page:
				...
				""")
		allure.dynamic.title("Services Page > User Log In validation > Positive test")
