...
class TestUserRegistrationDuplicateUsername(UserRegistrationCase):
	...
	def test_user_registration_duplicate_username(self):
		...
		User registration test case:
			...
			2. Fill out user personal data > Duplicate Username
			...
			8. Close web browser
		""")
		allure.dynamic.title("User registration > Negative test > Duplicate Username")
		...
		step_definition(self,
		                ...
		                expected=RegisterPageContent.FORM['username']['error_duplicate'],
